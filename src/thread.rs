...
use crate::{
    board::Board,
    history::{ContinuationHistory, CorrectionHistory, NoisyHistory, NullMoveHistory, QuietHistory, TTmoveHistory},
    nnue::Network,
    stack::Stack,
...
pub struct ThreadData<'a> {
    ...
    pub ttmove_history: TTmoveHistory,
...
impl<'a> ThreadData<'a> {
    pub fn new(tt: &'a TranspositionTable, stop: &'a AtomicBool, counter: &'a AtomicU64) -> Self {
        Self {
            ...
            ttmove_history: TTmoveHistory::default(),
