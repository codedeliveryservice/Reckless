...
pub struct ThreadData<'a> {
    ...
    pub no_knight_corrhist: [CorrectionHistory; 2],
    pub no_bishop_corrhist: [CorrectionHistory; 2],
    pub no_rook_corrhist: [CorrectionHistory; 2],
    pub no_queen_corrhist: [CorrectionHistory; 2],
...
impl<'a> ThreadData<'a> {
    pub fn new(tt: &'a TranspositionTable, stop: &'a AtomicBool, nodes: &'a AtomicU64, tb_hits: &'a AtomicU64) -> Self {
        Self {
            ...
            no_knight_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            no_bishop_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            no_rook_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            no_queen_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
