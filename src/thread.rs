...
use crate::{
    board::Board,
    history::{ContinuationCorrectionHistory, ContinuationHistory, CorrectionHistory, NoisyHistory, QuietHistory, StaticEvalHistory},
    nnue::Network,
    stack::Stack,
...
pub struct ThreadData<'a> {
    ...
    pub static_eval_history: StaticEvalHistory,
...
impl<'a> ThreadData<'a> {
    pub fn new(tt: &'a TranspositionTable, stop: &'a AtomicBool, nodes: &'a AtomicU64, tb_hits: &'a AtomicU64) -> Self {
        Self {
            ...
            static_eval_history: StaticEvalHistory::default(),
