...
pub struct ThreadData<'a> {
    ...
    pub pawn_corrhist: [CorrectionHistory; 2],
    pub minor_corrhist: [CorrectionHistory; 2],
    pub major_corrhist: [CorrectionHistory; 2],
    pub non_pawn_corrhist: [[CorrectionHistory; 2]; 2],
    pub prior_moves_corrhist: [[CorrectionHistory; 2]; 2],
...
impl<'a> ThreadData<'a> {
    pub fn new(
        ...
        Self {
            ...
            pawn_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            minor_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            major_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            non_pawn_corrhist: [
                [CorrectionHistory::default(), CorrectionHistory::default()],
                [CorrectionHistory::default(), CorrectionHistory::default()],
            ],
            prior_moves_corrhist: [
                [CorrectionHistory::default(), CorrectionHistory::default()],
                [CorrectionHistory::default(), CorrectionHistory::default()],
            ],
