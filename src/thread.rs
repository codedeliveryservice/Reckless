...
use crate::{
    board::Board,
    history::{ContinuationHistory, CorrectionHistory, NoisyHistory, QuietHistory, UniformCorrectionHistory},
    nnue::Network,
    stack::Stack,
...
pub struct ThreadData<'a> {
    ...
    pub prior_moves_corrhist: [UniformCorrectionHistory; 2],
...
impl<'a> ThreadData<'a> {
    pub fn new(
        ...
        Self {
            ...
            prior_moves_corrhist: [UniformCorrectionHistory::default(), UniformCorrectionHistory::default()],
