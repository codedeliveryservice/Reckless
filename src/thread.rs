...
pub struct ThreadData<'a> {
    ...
    pub last_quiet_move_corrhist: CorrectionHistory,
    pub last_noisy_move_corrhist: CorrectionHistory,
...
impl<'a> ThreadData<'a> {
    pub fn new(
        ...
        Self {
            ...
            last_quiet_move_corrhist: CorrectionHistory::default(),
            last_noisy_move_corrhist: CorrectionHistory::default(),
