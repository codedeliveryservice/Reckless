...
pub struct ThreadData<'a> {
    ...
    pub non_knight_corrhist: [CorrectionHistory; 2],
    pub non_bishop_corrhist: [CorrectionHistory; 2],
    pub non_rook_corrhist: [CorrectionHistory; 2],
    pub non_queen_corrhist: [CorrectionHistory; 2],
...
impl<'a> ThreadData<'a> {
    pub fn new(tt: &'a TranspositionTable, stop: &'a AtomicBool, nodes: &'a AtomicU64, tb_hits: &'a AtomicU64) -> Self {
        Self {
            ...
            non_knight_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            non_bishop_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            non_rook_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
            non_queen_corrhist: [CorrectionHistory::default(), CorrectionHistory::default()],
