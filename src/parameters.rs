...
define!(
    ...
    i32 tthit_sub: 64;
    i32 tthit_cap: 1367;
    i32 tthit_cont_scale: 124;
    i32 tthit_cont_sub: 64;
    i32 tthit_cont_cap: 1367;
    ...
    i32 see_history_quiet_factor: 42;
    i32 see_history_noisy_factor: 42;
    i32 se_depth_ext_cap: 12;
    i32 se_depth: 5;
    i32 se_double: 17;
    i32 se_triple: 97;
    i32 lmr_v1: 90;
    ...
    i32 corrhist_v5: 992;
    i32 corrhist_v6: 757;
    i32 corrhist_bonus_v1: 1024;
    i32 corrhist_bonus_v2: 1024;
    i32 corrhist_bonus_v3: 1024;
    i32 corrhist_bonus_v4: 1024;
    i32 corrhist_bonus_v5: 1024;
    i32 corrhist_bonus_v6: 1024;
    i32 corrhist_bonus_v7: 1024;
    i32 corrhist_clamp_min: 4096;
    i32 corrhist_clamp_max: 4096;
    i32 cont_v1: 1287;
    i32 cont_v2: 1323;
    i32 cont_v3: 937;
    i32 mp_v1: 1141;
    ...
    i32 mp_v3: 988;
    i32 mp_v4: 554;
    i32 score_noisy_pc: 2304;
    i32 score_noisy_hist: 1024;
    i32 material_base: 20000;
    i32 optimism_base: 2000;
    i32 eval_divisor: 32768;
    i32 optimims_v1: 128;
    i32 optimims_v2: 212;
    i32 alpha_raise_cap: 16;
    i32 corrhist_div: 96;
);
