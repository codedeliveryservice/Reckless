...
pub const RFP_MARGIN: i32 = 72;
pub const RFP_DEPTH: i32 = 7;

pub const RAZORING_DEPTH: i32 = 4;
pub const RAZORING_MARGIN: i32 = 195;
pub const RAZORING_FIXED_MARGIN: i32 = 143;

pub const LMR_MOVES_PLAYED: i32 = 3;
pub const LMR_DEPTH: i32 = 3;
pub const LMR_BASE: f64 = 0.74;
pub const LMR_DIVISOR: f64 = 2.21;
pub const LMR_HISTORY_DIVISOR: f64 = 5310.0;
