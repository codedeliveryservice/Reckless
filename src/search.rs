...
fn search<NODE: NodeType>(td: &mut ThreadData, mut alpha: i32, mut beta: i32, depth: i32, cut_node: bool) -> i32 {
    ...
    if best_move.is_some() {
        ...
        if best_move.is_noisy() {
            ...
            td.pawn_history.update(td.board.pawn_key(), td.board.side_to_move(), best_move, bonus_pawn);
            ...
            for &mv in quiet_moves.iter() {
                ...
                td.pawn_history.update(td.board.pawn_key(), td.board.side_to_move(), mv, -malus_pawn);
