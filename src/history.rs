...
impl ContinuationCorrectionHistory {
    ...
    pub fn subtable_ptr(
        &mut self, is_backward_absolute: bool, in_check: bool, capture: bool, piece: Piece, sq: Square,
    ) -> *mut PieceToHistory<i16> {
        self.entries[is_backward_absolute as usize][in_check as usize][capture as usize][piece][sq].as_mut_ptr().cast()
    }
