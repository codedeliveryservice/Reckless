...
impl ContinuationCorrectionHistory {
    ...
    pub fn subtable_ptr(
        &mut self, prev_capture: bool, in_check: bool, capture: bool, piece: Piece, sq: Square,
    ) -> *mut PieceToHistory<i16> {
        self.entries[prev_capture as usize][in_check as usize][capture as usize][piece][sq].as_mut_ptr().cast()
    }
