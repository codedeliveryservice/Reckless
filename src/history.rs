...
pub struct ContinuationHistory {
    ...
    entries: Box<[[[PieceToHistory<i32>; 64]; 13]; 2]>,
}

impl ContinuationHistory {
    const MAX_HISTORY: i32 = 16384;

    pub fn get(&self, piece: Piece, sq: Square, in_check: bool, cont_piece: Piece, cont_sq: Square) -> i32 {
        self.entries[in_check as usize][piece][sq][cont_piece][cont_sq]
    }

    pub fn update(&mut self, piece: Piece, sq: Square, in_check: bool, cont_piece: Piece, cont_sq: Square, bonus: i32) {
