...
impl ContinuationHistory {
    ...
    pub fn subtable_ptr(&mut self, has_captured: bool, piece: Piece, sq: Square) -> *mut [[i16; 64]; 13] {
        self.entries[has_captured as usize][piece][sq].as_mut_ptr() as *mut [[i16; 64]; 13]
    }
