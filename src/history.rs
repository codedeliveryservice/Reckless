...
pub struct PawnHistory {
    ...
    entries: Box<[[PieceToHistory<i16>; Self::SIZE]; 2]>,
}
...
impl PawnHistory {
    ...
    pub fn get(&self, stm: Color, key: u64, piece: Piece, sq: Square) -> i32 {
        self.entries[stm][key as usize & Self::MASK][piece][sq] as i32
    }

    pub fn update(&mut self, stm: Color, key: u64, piece: Piece, sq: Square, bonus: i32) {
