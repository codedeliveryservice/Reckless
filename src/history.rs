...
pub struct ContinuationCorrectionHistory {
    // [is_capture][piece][to][continuation_piece][continuation_to]
...
impl ContinuationCorrectionHistory {
    ...
    pub fn subtable_ptr(&mut self, is_capture: bool, piece: Piece, sq: Square) -> *mut PieceToHistory<i16> {
        self.entries[is_capture as usize][piece][sq].as_mut_ptr().cast()
    }
