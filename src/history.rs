...
pub struct ContinuationHistory {
    ...
    entries: Box<[[[PieceToHistory<i16>; 2]; 64]; 13]>,
}

impl ContinuationHistory {
    const MAX_HISTORY: i32 = 16384;

    pub fn get(&self, piece: Piece, sq: Square, cont_piece: Piece, cont_sq: Square, noisy: bool) -> i32 {
        self.entries[piece][sq][noisy as usize][cont_piece][cont_sq] as i32
    }

    pub fn update(&mut self, piece: Piece, sq: Square, cont_piece: Piece, cont_sq: Square, noisy: bool, bonus: i32) {
        let entry = &mut self.entries[piece][sq][noisy as usize][cont_piece][cont_sq];
