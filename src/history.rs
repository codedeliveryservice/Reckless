...
pub struct PawnHistory {
    // [key][piece][to]
    entries: Box<[PieceToHistory<i16>; PawnHistory::SIZE]>,
}

impl PawnHistory {
    const MAX_HISTORY: i32 = 16492;

    const SIZE: usize = 1024;
    const MASK: usize = Self::SIZE - 1;

    pub fn get(&self, key: u64, piece: Piece, sq: Square) -> i32 {
        (self.entries[key as usize & Self::MASK][piece][sq]) as i32
    }
