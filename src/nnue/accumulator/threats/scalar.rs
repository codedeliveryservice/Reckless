...
fn push_threats_single(
    ...
    let black_pawns = board.piece_by_color(Color::Black, PieceType::Pawn) & pawn_attacks(square, Color::White);
    let white_pawns = board.piece_by_color(Color::White, PieceType::Pawn) & pawn_attacks(square, Color::Black);
