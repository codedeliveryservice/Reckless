...
fn push_threats_single(
    ...
    let black_pawns = board.side_pieces(Color::Black, PieceType::Pawn) & pawn_attacks(square, Color::White);
    let white_pawns = board.side_pieces(Color::White, PieceType::Pawn) & pawn_attacks(square, Color::Black);
