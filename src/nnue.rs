...
impl Network {
    ...
    pub fn evaluate(&mut self, board: &Board) -> i32 {
        ...
        let output = self.output_transformer(board, bucket) / NETWORK_QA + PARAMETERS.output_bias[bucket] as i32;
    ...
    fn output_transformer(&mut self, board: &Board, bucket: usize) -> i32 {
