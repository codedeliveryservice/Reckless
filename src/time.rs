    ...
    pub fn new(limits: Limits, fullmove_number: usize, move_overhead: u64) -> Self {
        ...
        match limits {
            ...
            Limits::Fischer(main, inc) => {
                let soft_scale = 0.0243348 + 0.0421829 * (1.0 - (-0.0458879 * fullmove_number as f64).exp());
                let hard_scale = 0.1369000 + 0.1489909 * (1.0 - (-0.0434554 * fullmove_number as f64).exp());
